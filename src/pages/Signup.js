  ...
  return (
    <div className="container flex mx-auto max-w-screen-md items-center h-screen">
      ...
      <div className="flex  flex-col w-2/5">
        <div className="flex rounded flex-col items-center bg-white  p-4 border border-gray-primary mb-4">
          <h1 className="flex justify-center w-full ">
            <img
              src="/images/logo.png"
              alt="Instagram"
              className="mt-2 w6/12 mb-4"
            />
          </h1>
          {error && (
          ...
          <form onSubmit={handleSignup} method="POST">
            <input
              ...
              value={username}
              className="rounded mb-2 text-sm text-gray-base w-full  mr-3 py-5 px-4 h-2 border border-gray-primary"
            />
            <input
